...
test_that("backend_tuneR_backend_load", {
  waveform_and_sample_rate <- torchaudio:::backend_tuneR_backend_load(system.file("sample_audio_1.mp3", package = "torchaudio"))
  expect_equal(waveform_and_sample_rate[[2]], sample_mp3@samp.rate)
  expect_tensor(waveform_and_sample_rate[[1]])

  waveform_and_sample_rate <- torchaudio:::backend_tuneR_backend_load(
