...
```{r, echo=FALSE}
torch::torch_save(model, "../inst/cache/model.pt")
model <- torch::torch_load("../inst/cache/model.pt")
```
...
```{r, echo = FALSE}
# saveRDS(losses, "../inst/cache/losses.rds")
losses <- readRDS("../inst/cache/losses.rds")
```
